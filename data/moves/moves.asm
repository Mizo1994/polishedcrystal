...
if DEF(FAITHFUL)
	...
	move SING,            EFFECT_SLEEP,               0, FAIRY,      70, 10,   0, STATUS
...
if DEF(FAITHFUL)
	...
	move STRENGTH,        EFFECT_ALL_UP_HIT,         60, FIGHTING,  100, 10,  10, PHYSICAL
endc
	...
	move SLEEP_POWDER,    EFFECT_SLEEP,               0, GRASS,      75, 10,   0, STATUS
...
endc
	...
	move THUNDER,         EFFECT_THUNDER,           110, ELECTRIC,   80, 10,  30, SPECIAL
...
endc
	...
	move HYPNOSIS,        EFFECT_SLEEP,               0, PSYCHIC,    80,  5,   0, STATUS
...
endc
	...
	move ICICLE_CRASH,    EFFECT_FLINCH_HIT,         90, ICE,        90, 10,  30, PHYSICAL
	...
	move DIZZY_PUNCH,     EFFECT_CONFUSE_HIT,        70, FAIRY,     90, 15,  50, PHYSICAL
	move SPORE,           EFFECT_SLEEP,               0, GRASS,     100,  5,   0, STATUS
	move FLASH,           EFFECT_ACCURACY_DOWN,       0, NORMAL,    100, 20,   0, STATUS
	move EXTRASENSORY,    EFFECT_FLINCH_HIT,         80, PSYCHIC,   100, 15,  20, SPECIAL
...
endc
	...
	move HYPER_FANG,      EFFECT_FLINCH_HIT,         90, NORMAL,     90, 10,  30, PHYSICAL
	move BULK_UP,         EFFECT_BULK_UP,             0, FIGHTING,  100, 20,   0, STATUS
	move CONVERSION,      EFFECT_CONVERSION,          0, NORMAL,     -1, 30,   0, STATUS
	move TRI_ATTACK,      EFFECT_TRI_ATTACK,         85, NORMAL,    100, 15,  20, SPECIAL
	move SUPER_FANG,      EFFECT_SUPER_FANG,          1, NORMAL,     90, 10,   0, PHYSICAL
	move SLASH,           EFFECT_NORMAL_HIT,         75, NORMAL,    100, 20,   0, PHYSICAL
	...
	move SEED_BOMB,       EFFECT_NORMAL_HIT,         90, GRASS,     100, 10,   0, PHYSICAL
	move REVERSAL,        EFFECT_REVERSAL,            1, FIGHTING,  100, 15,   0, PHYSICAL
	move ASTONISH,        EFFECT_FLINCH_HIT,         40, GHOST,     100, 15,  30, PHYSICAL
...
if DEF(FAITHFUL)
	...
	move OCTAZOOKA,       EFFECT_ACCURACY_DOWN_HIT,  75, WATER,      95, 10,  100, SPECIAL
endc
	move SPIKES,          EFFECT_SPIKES,              0, GROUND,     -1, 20,   0, STATUS
	move ZAP_CANNON,      EFFECT_PARALYZE_HIT,      140, ELECTRIC,   55,  5, 100, SPECIAL
	...
	move FALSE_SWIPE,     EFFECT_FALSE_SWIPE,        50, NORMAL,    100, 40,   0, PHYSICAL
...
endc
	...
	move DYNAMICPUNCH,    EFFECT_CONFUSE_HIT,       100, FIGHTING,   70,  5, 100, PHYSICAL
...
endc
	...
	move IRON_TAIL,       EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,      85, 15,  50, PHYSICAL
	...
	move HURRICANE,       EFFECT_CONFUSE_HIT,       110, FLYING,     70, 10,  50, SPECIAL
...
endc
	move CROSS_CHOP,      EFFECT_NORMAL_HIT,        110, FIGHTING,   85,  5,   0, PHYSICAL
	...
	move FUTURE_SIGHT,    EFFECT_FUTURE_SIGHT,      140, PSYCHIC,   100, 10,   0, SPECIAL
if DEF(FAITHFUL)
