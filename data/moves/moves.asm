...
endc
	...
	move HORN_ATTACK,     EFFECT_NORMAL_HIT,         85, NORMAL,     85, 20,   0, PHYSICAL
...
if DEF(FAITHFUL)
	...
	move STRENGTH,        EFFECT_ALL_UP_HIT,         60, FIGHTING,  100, 10,   0, PHYSICAL
endc
...
endc
	...
	move ZEN_HEADBUTT,    EFFECT_FLINCH_HIT,         80, PSYCHIC,    95, 15,  20, PHYSICAL
