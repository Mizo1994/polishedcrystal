...
PidgeyEvosAttacks:
	...
	db 13, QUICK_ATTACK
	db 15, RAGE
	db 17, SWIFT ; Whirlwind → RBY TM move
	db 21, CHARM ; Twister → egg move
	db 25, FEINT_ATTACK ; Feather Dance → TM move
	db 29, WING_ATTACK
	db 33, AGILITY
	db 37, ROOST
...
PidgeottoEvosAttacks:
	...
	db 27, FEINT_ATTACK ; Feather Dance → TM move
	db 32, WING_ATTACK
	db 37, AGILITY
	db 42, ROOST
...
RattataPlainEvosAttacks:
	...
	db 19, SUCKER_PUNCH
	db 22, CRUNCH
	db 25, FLAME_CHARGE ; Assurance → similar move
	db 26, FEINT_ATTACK
	db 28, SUPER_FANG
	db 31, DOUBLE_EDGE
...
EkansEvosAttacks:
	...
	db 28, POISON_JAB ; Acid Spray → egg move
	db 35, CRUNCH ; Mud Bomb → TM move
...
ArbokEvosAttacks:
	...
	db 32, POISON_JAB ; Acid Spray → egg move
	db 37, CRUNCH ; Mud Bomb → TM move
...
RaichuPlainEvosAttacks:
	...
	db 20, THUNDER_WAVE
	db 22, MUD_SLAP ; Feint → GSC TM move
	db 25, DOUBLE_TEAM
	db 28, SPARK
	db 35, IRON_TAIL ; Nuzzle → TM move
	db 39, EXTREMESPEED ; Discharge → event move
	db 43, BODY_SLAM ; Slam → TM move
	db 48, THUNDERBOLT
	db 51, AGILITY
	db 56, WILD_CHARGE
	db 62, LIGHT_SCREEN
...
NidoranFEvosAttacks:
	...
	db 36, CRUNCH
	db 41, CHARM ; Captivate → egg move
	db 43, POISON_JAB
	db 47, SUPER_FANG
	db -1 ; no more level-up moves
...
NidorinaEvosAttacks:
	...
	db 43, CRUNCH
	db 45, CHARM ; Captivate → egg move
	db 52, POISON_JAB
	db 58, SUPER_FANG
	db -1 ; no more level-up moves
...
NidorinoEvosAttacks:
	...
	db 43, POISON_JAB
	db 47, CHARM ; Captivate → egg move
	db 52, MEGAHORN ; Horn Drill → Nidoking move
	db 58, SUPER_FANG
	db -1 ; no more level-up moves
...
NidokingEvosAttacks:
	...
	db 43, EARTH_POWER
	db 48, POISON_JAB
	db 53, CHARM ; Captivate → egg move
	db 58, MEGAHORN
	db 64, SUPER_FANG
	db -1 ; no more level-up moves
...
ClefableEvosAttacks:
	...
	db 13, DEFENSE_CURL
	db 16, SWEET_KISS ; Follow Me → new move
	db 22, DIZZY_PUNCH ; Bestow → Crystal unique move
	db 25, TRI_ATTACK ; Wake-Up Slap → RBY TM move
	db 28, MINIMIZE
	db 32, DRAINING_KISS ; Stored Power → Sw/Sh move
	db 35, METRONOME
	db 41, REFLECT ; Cosmic Power → TM move
	db 45, LIGHT_SCREEN ; Lucky Chant → TM move
	db 49, BODY_SLAM
	db 53, HEALINGLIGHT ; Moonlight → similar move
	db 58, MOONBLAST
	db 62, BELLY_DRUM ; Gravity → egg move
	db 66, EXTRASENSORY ; Meteor Mash → new move
	db 70, HEAL_BELL ; Healing Wish → HGSS tutor move
	db -1 ; no more level-up moves
...
VulpixPlainEvosAttacks:
	...
	db 34, SAFEGUARD
	db 36, FLAMETHROWER
	db 39, DREAM_EATER ; Imprison → egg move
	db 42, FIRE_BLAST
...
NinetalesPlainEvosAttacks:
	...
	db 25, FEINT_ATTACK
	db 28, HEX
	db 31, PAIN_SPLIT ; Flame Burst → HGSS tutor move
	db 34, EXTRASENSORY
	db 36, SAFEGUARD
	db 39, FLAMETHROWER
	db 42, DREAM_EATER ; Imprison → egg move
	db 47, FIRE_BLAST
	db 50, SHADOW_BALL ; Grudge → TM move
	db 53, DISABLE ; Captivate → egg move
	db 58, FLARE_BLITZ ; Inferno → egg move
	db 64, HEALINGLIGHT ; new move
	db -1 ; no more level-up moves
...
NinetalesAlolanEvosAttacks:
	...
	db 52, DISABLE ; Captivate → egg move
	db 58, MOONBLAST ; Sheer Cold → egg move
	db 63, HEALINGLIGHT ; new move
	db -1 ; no more level-up moves
...
WigglytuffEvosAttacks:
	...
	db 17, SWIFT
	db 20, ROLLOUT
	db 25, CHARM ; Round → Igglybuff move
	db 28, DIZZY_PUNCH
	db 30, MEAN_LOOK ; Wake-Up Slap → new move
	db 33, REST
	db 36, BODY_SLAM
	db 40, GYRO_BALL
	db 44, HEAL_BELL ; Mimic → HGSS tutor move
	db 50, HYPER_VOICE
	db 55, DOUBLE_EDGE
	db 60, PERISH_SONG
	db -1 ; no more level-up moves
...
ZubatEvosAttacks:
	...
	db 5, SUPERSONIC
	db 7, ASTONISH
	db 11, WING_ATTACK ; Wing Attack → egg move
	db 14, HYPNOSIS
	db 17, CONFUSE_RAY
...
ParasEvosAttacks:
	...
	db -1 ; no more evolutions
	db 1, SCRATCH
	db 1, SLEEP_POWDER ; LGPE move
	db 1, STUN_SPORE
	db 1, POISONPOWDER
	db 7, ABSORB
	db 10, BUG_BITE ; Fury Cutter → egg move
	db 14, PSYBEAM
	db 18, METAL_CLAW
	db 22, SPORE
	db 25, LEECH_SEED
...
ParasectEvosAttacks:
	...
	db 47, GIGA_DRAIN
	db 52, POISON_JAB
	db 55, LEECH_LIFE ; Aromatherapy → TM move
	db 61, HEALINGLIGHT ; Rage Powder → new move
	db 66, CRABHAMMER
	db -1 ; no more level-up moves
...
ArcaninePlainEvosAttacks:
	...
	db 17, FIRE_SPIN ; Flame Wheel → egg move
	db 19, REVERSAL
	db 23, DOUBLE_KICK ; Fire Fang → egg move
	db 26, TAKE_DOWN
	db 30, FLAME_CHARGE ; Flame Burst → TM move
	db 33, AGILITY
	db 35, THRASH ; Retaliate → egg move
	db 38, FLAMETHROWER
	db 40, CRUNCH
	db 46, SUNNY_DAY ; Heat Wave → TM move
	db 50, OUTRAGE
	db 54, PLAY_ROUGH ; Flare Blitz → LGPE move
	db 61, FLARE_BLITZ
	db 65, CLOSE_COMBAT
	db -1 ; no more level-up moves
...
ArcanineHisuianEvosAttacks:
	...
	db 17, FIRE_SPIN ; Flame Wheel → egg move
	db 19, REVERSAL
	db 22, ROCK_BLAST ; Fire Fang → new move
	db 25, TAKE_DOWN
	db 30, FLAME_CHARGE ; Flame Burst → TM move
	db 32, AGILITY
	db 35, ROCK_SLIDE
	db 38, FLAMETHROWER
	db 41, CRUNCH
	db 46, POWER_GEM ; Heat Wave → new move
	db 50, OUTRAGE
	db 54, PLAY_ROUGH ; Flare Blitz → LGPE move
	db 61, FLARE_BLITZ
	db 65, CLOSE_COMBAT
...
AlakazamEvosAttacks:
	...
	db 28, LIGHT_SCREEN ; Psycho Cut → egg move
	db 31, RECOVER
	db 36, BARRIER ; Telekinesis → egg move
	db 40, BATON_PASS ; Ally Switch → new move
	db 46, PSYCHIC_M
	db 51, AURA_SPHERE
	db 54, CONFUSE_RAY ; Role Play → new move
	db 59, FUTURE_SIGHT
	db -1 ; no more level-up moves
...
BellsproutEvosAttacks:
	...
	db 54, POWER_WHIP ; Wring Out → egg move
	db -1 ; no more level-up moves
...
WeepinbellEvosAttacks:
	...
	db 24, KNOCK_OFF
	db 33, RAZOR_LEAF
	db 38, HEALINGLIGHT ; Gastro Acid → new move
	db 44, SWEET_KISS
	db 46, POISON_JAB
	db 52, SUCKER_PUNCH ; Slam → HGSS tutor move
	db 57, SWORDS_DANCE ; Wring Out → egg move
	db 61, POWER_WHIP ; Wring Out → egg move
	db -1 ; no more level-up moves
...
TentacruelEvosAttacks:
	...
	db 39, SCREECH
	db 42, HEX
	db 46, SLUDGE_BOMB ; Sludge Wave → TM move
	db 52, HYDRO_PUMP
	db 55, DARK_PULSE
	db -1 ; no more level-up moves
...
PonytaPlainEvosAttacks:
	evo_data EVOLVE_LEVEL, 33, RAPIDASH, PLAIN_FORM
	db -1 ; no more evolutions
	db 1, GROWL
	db 1, TACKLE
	db 1, DOUBLE_KICK
...
PonytaGalarianEvosAttacks:
	evo_data EVOLVE_LEVEL, 33, RAPIDASH, GALARIAN_FORM
	db -1 ; no more evolutions
	db 1, GROWL
	db 1, TACKLE
	db 1, DOUBLE_KICK
...
RapidashPlainEvosAttacks:
	...
	db 41, AGILITY
	db 44, FIRE_BLAST
	db 47, EXTREMESPEED ; Bounce → new move
	db 52, FLARE_BLITZ
	db 58, HYPNOSIS
	db 64, HI_JUMP_KICK
	db -1 ; no more level-up moves
...
RapidashGalarianEvosAttacks:
	...
	db 44, ZEN_HEADBUTT
	db 47, EXTREMESPEED ; Bounce → new move
	db 52, MOONBLAST ; Healing Wish → new move
	db 58, HYPNOSIS
	db 64, HI_JUMP_KICK
	db -1 ; no more level-up moves
...
DrowzeeEvosAttacks:
	...
	db 35, BELLY_DRUM ; Synchronoise → event move
	db 38, ZEN_HEADBUTT
	db 41, SWAGGER
	db 45, PSYCHIC_M
	db 49, NASTY_PLOT
	db 52, TOXIC ; Psyshock → TM move
	db 56, FUTURE_SIGHT
	db 56, DREAM_EATER
	db -1 ; no more level-up moves
...
ExeggutorPlainEvosAttacks:
	...
	db 1, POWER_WHIP ; Wood Hammer → new move
	db 1, PETAL_DANCE ; Leaf Storm → new move
	db 1, HYPNOSIS
	db 7, REFLECT
	db 11, LEECH_SEED
	db 14, CONFUSION
	...
	db 47, EXTRASENSORY
	db 50, PSYCHIC_M ; Bestow → TM move
	db 57, POWER_WHIP ; Wood Hammer → new move
	db -1 ; no more level-up moves
...
ExeggutorAlolanEvosAttacks:
	...
	db 1, TACKLE ; Barrage → new move
	db 1, HYPNOSIS
	db 1, DRAGON_RAGE ; Psyshock → new move
	db 1, ZEN_HEADBUTT ; Egg Bomb → tutor move
	db 1, POWER_WHIP ; Wood Hammer → new move
	db 1, OUTRAGE ; Leaf Storm → S/M TM move
	db 1, CONFUSION
	db 7, REFLECT
	db 11, LEECH_SEED
	db 14, CONFUSION
	...
	db 43, SOLAR_BEAM
	db 47, EXTRASENSORY
	db 50, DRAGON_PULSE ; Bestow → TM move
	db 57, DRAGON_PULSE ; evolution move
	db -1 ; no more level-up moves
...
CuboneEvosAttacks:
	...
	db 39, SING ; Stomping Tantrum → new move
...
MarowakPlainEvosAttacks:
	...
	db 45, SING ; Stomping Tantrum → new move
...
HitmonchanEvosAttacks:
	...
	db 25, SEISMIC_TOSS ; Vacuum Wave → RBY TM move
	db 28, THUNDERPUNCH
	db 28, ICE_PUNCH
	db 28, FIRE_PUNCH
	db 32, FORESIGHT ; Quick Guard → new move
	db 36, DRAIN_PUNCH
...
TaurosPaldeanFireEvosAttacks:
	...
	db 19, REST
	db 22, DOUBLE_KICK
	db 27, FOCUS_ENERGY ; Work Up → LGPE move
	db 33, TAKE_DOWN
	db 36, ZEN_HEADBUTT
	db 43, SWAGGER
	db 48, THRASH
...
EeveeEvosAttacks:
	...
	db 20, FLAME_CHARGE ; Covet → TM move
	db 20, WATER_PULSE ; Covet → TM move
	db 20, PSYBEAM ; Covet → TM move
	db 20, AURORA_BEAM ; Covet → TM move
	db 20, DRAINING_KISS ; Covet → TM move
...
JolteonEvosAttacks:
	...
	db 13, QUICK_ATTACK
	db 17, LIGHT_SCREEN
	db 20, VOLT_SWITCH ; Thunder Fang → TM move
	db 23, HEAL_BELL ; Refresh → HGSS tutor move
	db 25, PIN_MISSILE
	db 29, AGILITY
	db 33, THUNDER_WAVE
...
FlareonEvosAttacks:
	...
	db 23, HEAL_BELL ; Refresh → HGSS tutor move
	db 25, BODY_SLAM ; Fire Spin → TM move
	db 29, SCARY_FACE
	db 33, SMOKESCREEN ; Smog → new move
	db 37, CRUNCH ; Lava Plume → new move
	db 41, DOUBLE_EDGE ; Last Resort → tutor move
	db 45, FLARE_BLITZ
	db -1 ; no more level-up moves
...
OmanyteEvosAttacks:
	...
	db 7, BITE
	db 10, WATER_GUN
	db 13, ROCK_THROW ; Rollout → event move
	db 16, ANCIENTPOWER
	db 19, LEER
...
OmastarEvosAttacks:
	...
	db 1, POWER_GEM ; Spike Cannon → new move ; evolution move
	db 1, WRAP ; Constrict → similar move
	db 1, DEFENSE_CURL ; Withdraw → similar move
	db 7, BITE
	db 10, WATER_GUN
	...
	db 34, PROTECT
	db 40, EARTH_POWER
	db 45, AURORA_BEAM ; Tickle → egg move
	db 52, ROCK_BLAST
	db 56, SHELL_SMASH
	db 63, HYDRO_PUMP
	db 70, POWER_GEM ; new move
	db -1 ; no more level-up moves
...
KabutoEvosAttacks:
	...
	db 1, DEFENSE_CURL ; Harden → similar move
	db 6, ABSORB
	db 10, MUD_SLAP ; Leer → GSC TM move
	db 13, ROCK_THROW ; Mud Shot → Rock Throw (event move)
	db 16, ANCIENTPOWER
	db 19, LEER ; Sand Attack → Leer
	db 22, ENDURE
	db 28, AQUA_JET
	db 33, MEGA_DRAIN
	db 39, SCREECH ; Metal Sound → similar move
	db 43, GIGA_DRAIN ; Wring Out → TM move
	db 49, IRON_HEAD ; new move
	db 53, SHELL_SMASH ; new move
	db 58, CRABHAMMER ; new move
	db -1 ; no more level-up moves

KabutopsEvosAttacks:
	db -1 ; no more evolutions
	db 1, SLASH ; evolution move
	db 1, CRABHAMMER ; evolution move
	...
	db 33, MEGA_DRAIN
	db 39, SCREECH ; Metal Sound → similar move
	db 46, LEECH_LIFE ; Wring Out → TM move
	db 52, NIGHT_SLASH ; new move
	db 59, ROCK_SLIDE
	db 63, SHELL_SMASH ; new move
	db 70, CRABHAMMER ; new move
	db -1 ; no more level-up moves
...
ChikoritaEvosAttacks:
	...
	db 17, REFLECT
	db 17, LIGHT_SCREEN
	db 20, DRAINING_KISS ; Magical Leaf → new move
...
BayleefEvosAttacks:
	...
	db 17, REFLECT
	db 17, LIGHT_SCREEN
	db 22, DRAINING_KISS ; Magical Leaf → new move
	db 25, ENERGY_BALL ; Natural Gift → tutor move
	db 30, ANCIENTPOWER ; Sweet Scent → HGSS tutor move
	db 33, DAZZLINGLEAM ; Light Screen → TM move
	db 35, EARTH_POWER
	db 37, BODY_SLAM
	db 41, SAFEGUARD
	db 45, PLAY_ROUGH ; Aromatherapy → new move
	db 48, SOLAR_BEAM
	db 51, HEAL_BELL ; Aromatherapy → similar move
	db 55, OUTRAGE ; HGSS tutor move
	db 62, MOONBLAST ; new move
	db -1 ; no more level-up moves
...
MeganiumEvosAttacks:
	...
	db 37, BODY_SLAM
	db 42, SAFEGUARD
	db 48, PLAY_ROUGH ; Aromatherapy → new move
	db 56, SOLAR_BEAM
	db 62, HEAL_BELL ; Aromatherapy → similar move
	db 68, OUTRAGE ; HGSS tutor move
	db 73, MOONBLAST ; new move
	db -1 ; no more level-up moves
...
CyndaquilEvosAttacks:
	...
	db 28, SWIFT
	db 30, EXTRASENSORY
	db 32, REVERSAL ; Lava Plume → egg move
	db 35, FLAMETHROWER
	db 40, EARTH_POWER ; Inferno → new move
	db 46, ROLLOUT
	db 51, DOUBLE_EDGE
	db 55, EARTHQUAKE ; Burn Up → TM move
	db 60, FLARE_BLITZ ; Eruption → egg move
	db -1 ; no more level-up moves
...
QuilavaEvosAttacks:
	...
	db 41, FLAMETHROWER
	db 48, EARTH_POWER ; Inferno → new move
	db 53, ROLLOUT
	db 57, DOUBLE_EDGE
	db 63, EARTHQUAKE ; Burn Up → TM move
	db 69, FLARE_BLITZ ; Eruption → egg move
	db -1 ; no more level-up moves
...
TyphlosionPlainEvosAttacks:
	...
	db 60, ROLLOUT
	db 66, DOUBLE_EDGE
	db 70, EARTHQUAKE ; Burn Up → TM move
	db 76, FLARE_BLITZ ; Eruption → egg move
	db -1 ; no more level-up moves
...
TyphlosionHisuianEvosAttacks:
	...
	db 30, SWIFT
	db 34, EXTRASENSORY
	db 38, HEX ; Lava Plume → egg move
	db 43, WILL_O_WISP
	db 46, FLAMETHROWER
	db 53, SHADOW_BALL ; Inferno → new move
	db 60, ROLLOUT
	db 66, DOUBLE_EDGE
	db 70, DARK_PULSE ; Burn Up → TM move
	db 76, FLARE_BLITZ ; Eruption → egg move
	db -1 ; no more level-up moves
...
TotodileEvosAttacks:
	...
	db 53, DRAGON_DANCE ; Superpower → similar move
	db 56, HYDRO_PUMP
	db -1 ; no more level-up moves
...
CroconawEvosAttacks:
	...
	db 62, DRAGON_DANCE ; Superpower → similar move
	db 66, HYDRO_PUMP
	db -1 ; no more level-up moves
...
FeraligatrEvosAttacks:
	...
	db 81, DRAGON_DANCE ; Superpower → similar move
	db 84, HYDRO_PUMP
	db -1 ; no more level-up moves
...
LedianEvosAttacks:
	...
	db 24, FIRE_PUNCH ; Helping Hand → event move
	db 24, ICE_PUNCH ; Helping Hand → event move
	db 24, THUNDERPUNCH ; Helping Hand → event move
	db 29, BATON_PASS
	db 33, AGILITY
	db 38, BUG_BUZZ
	db 42, AIR_SLASH
	db 45, DRAIN_PUNCH ; Helping Hand → event move
	db 47, DOUBLE_EDGE
	db -1 ; no more level-up moves
...
NatuEvosAttacks:
	...
	db 15, HYPNOSIS ; Stored Power → new move
	db 17, EXTRASENSORY ; Stored Power → new move
...
XatuEvosAttacks:
	...
	db 20, PAIN_SPLIT ; Ominous Wind → HGSS tutor move
	db 25, CONFUSE_RAY
	db 31, RECOVER ; Wish → similar move
	db 36, PSYCHIC_M
	db 39, ROOST ; Miracle Eye → egg move
	db 42, HAZE ; Psycho Shift → egg move
	db 47, FUTURE_SIGHT
	db 53, HEX ; Power Swap + Guard Swap → new move
	db 58, SUCKER_PUNCH ; Me First → HGSS tutor move
	db -1 ; no more level-up moves
...
SnubbullEvosAttacks:
	...
	db 46, CLOSE_COMBAT ; Payback → event move
	db 49, CRUNCH
	db -1 ; no more level-up moves
...
GranbullEvosAttacks:
	...
	db 55, CLOSE_COMBAT ; Payback → event move
	db 59, CRUNCH
	db 67, OUTRAGE
	db -1 ; no more level-up moves
...
MismagiusEvosAttacks:
	...
	db 1, ENERGY_BALL ; Phantom Force → TM move
...
GlaceonEvosAttacks:
	...
	db 13, ICE_SHARD
	db 17, BITE
	db 20, AURORA_BEAM ; Ice Fang → Ice Shard
	db 23, HEAL_BELL
...
SylveonEvosAttacks:
	...
	db 23, HEAL_BELL
	db 25, SKILL_SWAP
	db 29, SING ; Misty Terrain → HGSS tutor move
	db 33, LIGHT_SCREEN
	db 37, MOONBLAST
	db 41, DOUBLE_EDGE ; Last Resort → tutor move
