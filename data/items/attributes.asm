...
; LOVE BALL
	item_attribute 300, 0, 0, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; REPEAT BALL
	item_attribute 500, 0, 0, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; TIMER BALL
	item_attribute 500, 0, 0, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; NEST BALL
	item_attribute 500, 0, 0, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
...
; PREMIER BALL
	item_attribute 200, 0, 0, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; CHERISH BALL
	item_attribute 50000, 0, 0, BALL, ITEMMENU_PARTY, ITEMMENU_CLOSE
; POTION
...
; CHERI BERRY
	item_attribute 200, HELD_HEAL_STATUS, 1 << PAR, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; CHESTO BERRY
	item_attribute 200, HELD_HEAL_STATUS, SLP_MASK, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; PECHA BERRY
	item_attribute 200, HELD_HEAL_STATUS, 1 << PSN, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; RAWST BERRY
	item_attribute 200, HELD_HEAL_STATUS, 1 << BRN, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; ASPEAR BERRY
	item_attribute 200, HELD_HEAL_STATUS, 1 << FRZ, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; LEPPA BERRY
	item_attribute 10, HELD_RESTORE_PP, -1, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; ORAN BERRY
	item_attribute 200, HELD_BERRY, 10, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; PERSIM BERRY
	item_attribute 200, HELD_HEAL_CONFUSE, 0, BERRIES, ITEMMENU_NOUSE, ITEMMENU_PARTY
; LUM BERRY
	item_attribute 200, HELD_HEAL_STATUS, -1, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; SITRUS BERRY
	item_attribute 10, HELD_BERRY, 0, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; FIGY BERRY
	item_attribute 200, HELD_BERRY, 0, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; POMEG BERRY
	item_attribute 200, HELD_NO_BUG_BITE, MON_HP_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; KELPSY BERRY
	item_attribute 200, HELD_NO_BUG_BITE, MON_ATK_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; QUALOT BERRY
	item_attribute 200, HELD_NO_BUG_BITE, MON_DEF_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; HONDEW BERRY
	item_attribute 200, HELD_NO_BUG_BITE, MON_SAT_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; GREPA BERRY
	item_attribute 200, HELD_NO_BUG_BITE, MON_SDF_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TAMATO BERRY
	item_attribute 200, HELD_NO_BUG_BITE, MON_SPE_EV - MON_EVS, BERRIES, ITEMMENU_PARTY, ITEMMENU_NOUSE
; LIECHI BERRY
	item_attribute 200, HELD_RAISE_STAT, ATTACK, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; GANLON BERRY
	item_attribute 200, HELD_RAISE_STAT, DEFENSE, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; SALAC BERRY
	item_attribute 200, HELD_RAISE_STAT, SPEED, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; PETAYA BERRY
...
; LANSAT BERRY
	item_attribute 200, HELD_RAISE_CRIT, 0, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; STARF BERRY
	item_attribute 200, HELD_RAISE_STAT, $10 | MULTIPLE_STATS, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; ENIGMA BERRY
	item_attribute 200, HELD_ENIGMA_BERRY, 0, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; CUSTAP BERRY
	item_attribute 200, HELD_CUSTAP_BERRY, 0, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; JABOCA BERRY
	item_attribute 200, HELD_OFFEND_HIT, PHYSICAL, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; ROWAP BERRY
	item_attribute 200, HELD_OFFEND_HIT, SPECIAL, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; KEE BERRY
	item_attribute 200, HELD_DEFEND_HIT, PHYSICAL, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; MARANGABERRY
	item_attribute 200, HELD_DEFEND_HIT, SPECIAL, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; BERRY JUICE
	item_attribute 350, HELD_BERRY, 20, BERRIES, ITEMMENU_PARTY, ITEMMENU_PARTY
; REPEL
